...
#include "stanExports_lm_random_id.h"

RCPP_MODULE(stan_fit4lm_random_id_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_lm_random_id")
