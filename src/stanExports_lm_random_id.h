...
namespace model_lm_random_id_namespace {
...
static constexpr std::array<const char*, 39> locations_array__ =
  ...
  " (in 'string', line 42, column 4 to column 38)",
  " (in 'string', line 43, column 4 to column 38)",
  " (in 'string', line 41, column 17 to line 44, column 3)",
  " (in 'string', line 41, column 2 to line 44, column 3)",
  " (in 'string', line 25, column 2 to column 23)",
  ...
  " (in 'string', line 32, column 4 to column 77)",
  ...
  " (in 'string', line 10, column 30 to column 31)",
  " (in 'string', line 10, column 2 to column 33)",
  " (in 'string', line 18, column 12 to column 13)",
...
class model_lm_random_id final : public model_base_crtp<model_lm_random_id> {
private:
  int N;
...
public:
  ~model_lm_random_id() {}
  model_lm_random_id(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_lm_random_id_namespace::model_lm_random_id";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_non_negative_index("intercept_id", "J", J);
      current_statement__ = 38;
      stan::math::validate_non_negative_index("slope_id", "J", J);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
    num_params_r__ = 1 + 1 + 1 + 2 + ((2 * (2 - 1)) / 2) + (2 * J);
  }
  inline std::string model_name() const final {
    return "model_lm_random_id";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_lm_random_id_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      Eigen::Matrix<local_scalar_t__,-1,-1> z =
        Eigen::Matrix<local_scalar_t__,-1,-1>::Constant(2, J, DUMMY_VAR__);
      current_statement__ = 6;
      z = in__.template read<Eigen::Matrix<local_scalar_t__,-1,-1>>(2, J);
      Eigen::Matrix<local_scalar_t__,-1,-1> b =
        Eigen::Matrix<local_scalar_t__,-1,-1>::Constant(2, J, DUMMY_VAR__);
      current_statement__ = 11;
      stan::model::assign(b,
        stan::math::multiply(stan::math::diag_pre_multiply(tau, L_Omega), z),
        "assigning variable b");
      {
        ...
        lp_accum__.add(stan::math::exponential_lpdf<propto__>(tau, 1));
          ...
          mu_n = (((alpha + (beta *
            ...
            stan::model::rvalue(b, "b", stan::model::index_uni(1),
              stan::model::index_uni(
                stan::model::rvalue(group, "group", stan::model::index_uni(n)))))
            +
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_lm_random_id_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      Eigen::Matrix<double,-1,-1> Omega =
        Eigen::Matrix<double,-1,-1>::Constant(2, 2,
          std::numeric_limits<double>::quiet_NaN());
      Eigen::Matrix<double,-1,1> intercept_id =
        Eigen::Matrix<double,-1,1>::Constant(J,
          std::numeric_limits<double>::quiet_NaN());
      Eigen::Matrix<double,-1,1> slope_id =
        Eigen::Matrix<double,-1,1>::Constant(J,
          std::numeric_limits<double>::quiet_NaN());
      ...
      for (int j = 1; j <= J; ++j) {
        ...
        stan::model::assign(intercept_id, (alpha +
          stan::model::rvalue(b, "b", stan::model::index_uni(1),
            stan::model::index_uni(j))), "assigning variable intercept_id",
          stan::model::index_uni(j));
        current_statement__ = 14;
        stan::model::assign(slope_id, (beta +
          stan::model::rvalue(b, "b", stan::model::index_uni(2),
            stan::model::index_uni(j))), "assigning variable slope_id",
          stan::model::index_uni(j));
      }
      current_statement__ = 8;
      stan::math::check_corr_matrix(function__, "Omega", Omega);
      out__.write(Omega);
      out__.write(intercept_id);
      out__.write(slope_id);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  }
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      current_statement__ = 6;
      stan::model::assign(z,
        in__.read<Eigen::Matrix<local_scalar_t__,-1,-1>>(2, J),
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      context__.validate_dims("parameter initialization", "z", "double",
        std::vector<size_t>{static_cast<size_t>(2), static_cast<size_t>(J)});
      int pos__ = std::numeric_limits<int>::min();
      pos__ = 1;
      local_scalar_t__ alpha = DUMMY_VAR__;
      current_statement__ = 1;
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"alpha", "beta", "sigma", "tau",
                "L_Omega", "z"};
    if (emit_transformed_parameters__) {
    ...
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"Omega", "intercept_id", "slope_id"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
  }
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    if (emit_generated_quantities__) {
      ...
      for (int sym1__ = 1; sym1__ <= J; ++sym1__) {
        param_names__.emplace_back(std::string() + "intercept_id" + '.' +
          std::to_string(sym1__));
      }
      for (int sym1__ = 1; sym1__ <= J; ++sym1__) {
        param_names__.emplace_back(std::string() + "slope_id" + '.' +
          std::to_string(sym1__));
      }
    }
  }
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"L_Omega\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"z\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(J) + "},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(J) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Omega\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"generated_quantities\"},{\"name\":\"intercept_id\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"generated_quantities\"},{\"name\":\"slope_id\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"L_Omega\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(((2 * (2 - 1)) /2)) + "},\"block\":\"parameters\"},{\"name\":\"z\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(J) + "},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(J) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Omega\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(((2 * (2 - 1)) /2)) + "},\"block\":\"generated_quantities\"},{\"name\":\"intercept_id\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"generated_quantities\"},{\"name\":\"slope_id\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((1 + 1) + 1) + 2) + (2 * 2)) + (2 * J));
    const size_t num_transformed = emit_transformed_parameters * ((2 * J));
...
using stan_model = model_lm_random_id_namespace::model_lm_random_id;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_lm_random_id_namespace::profiles__;
}
#endif
#endif
